...
export function EditSkuModal({ isOpen, onClose, onSubmit, sku, warehouseOptions, vendorOptions }: EditSkuModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/80 backdrop-blur-md flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-2xl w-11/12 md:w-10/12 lg:w-9/12 xl:w-3/4 max-w-6xl transform transition-all duration-300 scale-100 opacity-100">
        {/* Modal header */}
        <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-t-2xl p-2 flex justify-between items-center">
        ...
        <div className="p-6 bg-gray-50">
          <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[68vh] pr-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-100" 
                    readOnly
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="50" 
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200 bg-gray-100" 
                    readOnly
                  />
                </div>
              </div>
            ...
            <div className="pt-5 border-t border-gray-200 flex flex-col sm:flex-row justify-center sm:justify-end space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <button 
                type="submit"
                className="px-6 py-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white font-medium rounded-lg hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition duration-200 shadow-md flex items-center justify-center"
              >
